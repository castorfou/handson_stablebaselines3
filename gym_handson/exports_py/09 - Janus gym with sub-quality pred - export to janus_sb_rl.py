...
library_name = "janus_sq_rl"

get_ipython().system('python notebook2script.py --fnameout=$library_name".py"  "09 - Janus gym with sub-quality pred - export to janus_sb_rl.ipynb"')
