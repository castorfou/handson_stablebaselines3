...
library_name = "janus_rl2"

get_ipython().system('python notebook2script.py --fnameout=$library_name".py"  "07 - Janus env library - janus_rl2.ipynb"')
...
def train_RL_model(exp_number, idx, reward_name, nb_actions = 4):
    ...
    '''
    janus = Janus(idx, reward_name, nbr_actions=nb_actions)
    check_env(janus)
...
train_RL_model(11, 2230, 'clown_hat', nb_actions=6)
